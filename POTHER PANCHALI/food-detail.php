...
?>
  ...
  <button  type="submit" name="submit" class="btn theme-btn btn-lg arnab " data-row-id="<?php echo $row['ID'];?>" data-row-name="<?php echo $row['ItemName'];?>" data-row-price="<?php echo $row['ItemPrice'];?>"id="arnab-<?php echo $row['ID'];?>" >Order Now</button>
                               </div>
