<nav class="navbar navbar-dark">
               <div class="container">
                  ...
                  <a class="navbar-brand" href="index.php"> POTHER PANCHALI </a>
                  <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                     <ul class="nav navbar-nav">
                        <li class="nav-item"> <a class="nav-link active" href="index.php">Home <span class="sr-only">(current)</span></a> </li>
                     
                        <li class="nav-item"> <a class="nav-link" href="category.php?pageno=1">Food Menu</a> </li>
...
<?php } ?>
 ...
 <?php if (strlen($_SESSION['fosuid']>0)) {?>
                       ...
                       <strong><li class="nav-item" ><a href="cart.php"  class="nav-link" style="color: red"> Cart
                            (<?php
                            if(isset($_SESSION["cart_details"])){
              $count = count($_SESSION["cart_details"]); 
              echo "$count"; 
            }
              else
                echo "0";
