...
$uid=$_SESSION['fosuid'];
      ...
      $count=1;
         ...
         <h5> <h5><a href="order-details.php?orderid=<?php echo $row['Ordernumber'];?>">Order # <?php echo $row['Ordernumber'];?></a></h5> # <?php echo $row['Ordernumber'];?></a></h5> 
...
<a href="comp.php?orderid=<?php echo $row['Ordernumber'];?>" class="btn theme-btn-dash pull-right">TRACK ORDER</a>
<?php }
                                      ...
                                      ?> </div>
                                      <a href="cancelorder.php?orderid=<?php echo $row['Ordernumber'];?>">Cancel Order</a>
